...
| ID | Name | Description | Method | Endpoint | Parameters | Responses |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **COMP-01** | Get Next Pair | Get the next pair of features to compare based on highest information gain (max variance reduction). Returns 204 when target certainty is reached or no useful comparisons remain. | `GET` | `/projects/{projectId}/comparisons/next` | **Path**: `projectId`<br>**Query**: `dimension` (enum: complexity, value), `target_certainty` (float, optional, default 0.0) | **200 OK**: `{ "comparison_id": "uuid", "feature_a": { "id": "uuid", "name": "string", "description": "string" }, "feature_b": { "id": "uuid", "name": "string", "description": "string" }, "dimension": "string" }`<br>**204 No Content** (if target certainty reached or no useful comparisons left) |
...
| **COMP-07** | Get Resolution Pair | Get a specific pair of features to compare to resolve a detected inconsistency. Identifies the "weakest link" in cycles (highest combined uncertainty). | `GET` | `/projects/{projectId}/comparisons/resolve-inconsistency` | **Path**: `projectId`<br>**Query**: `dimension` (required) | **200 OK**: `{ "comparison_id": null, "feature_a": { "id": "uuid", "name": "string", ... }, "feature_b": { "id": "uuid", "name": "string", ... }, "dimension": "string", "reason": "string", "combined_uncertainty": float }`<br>**204 No Content** (no inconsistencies detected) |
